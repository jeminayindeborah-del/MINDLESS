...
$title = '$MINDLESS Airdrop | Claim Your Tokens';
$desc  = 'The $MINDLESS Airdrop is Live. Eligible users are invited to take part in the distribution of $MINDLESS tokens.';
$alt   = '$MINDLESS Airdrop - Claim Your Tokens';
$name  = '$MINDLESS';
